...
export default async function AnalysisPage() {
    ...
    const eventData = await getEvents({ fields: ["week", "awards", "projections"] });
    ...
    return <div className="pt-12 flex justify-center flex-wrap w-full mb-24 px-6">
        <div className="max-w-[800px] w-full">
            <section className="w-full text-left">
                ...
                <div className="mt-6 flex space-x-2 w-full justify-center items-center flex-wrap">
                    <div className="my-1 bg-stone-100 text-center rounded-2xl shadow-xl w-48 h-48 flex justify-center items-center flex-wrap">
                        <div>
